...
export const volumeSlideBar = `
  <div class="ytp-volume-panel" role="slider" aria-valuemin="0" aria-valuemax="100" tabindex="0" aria-valuenow="95" aria-valuetext="95% âm lượng" style="">
    <div class="ytp-volume-slider" draggable="true" style="touch-action: none;">
      <div class="ytp-volume-slider-handle" style="left: 38px;">
      </div>
    </div>
  </div>
`;
