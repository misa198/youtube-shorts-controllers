...
<div id="shorts-controller-overlay">
  <div class="processbar-wrapper">
    <div class="processbar">
      <div class="processbar__container">
        <div class="processbar__thumb">
          <div class="processbar__thumb__inner">
            <div class="processbar__thumb__inner__dot"></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="buttons-session">
    <div class="navigate-buttons__buttons">
      ...
      <div class='buttons-session__process'>
        00:00/00:00
      </div>
    </div>
    <button class="mute-button ytp-button">
      <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
        <path
